...
**LETOP: ook als je Git al hebt geinstalleerd: lees de onderstaande opdracht goed door en zorg ervoor dat alles werkt zoals verwacht wordt.**
...
Opvolgende opdrachten in deze module maken je wegwijs in de werking van Git en Github maar voor nu gaan we beginnen met het installeren van Git, wat instellingen doen en een account aanmaken op Github.
